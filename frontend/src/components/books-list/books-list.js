    ...
    return (
        <>
            <div className={`${classes.pageHeader} ${classes.mb2}`}>
                <Typography variant="h5" sx={{ color: "white", textAlign: "center" }}>Book List</Typography>
                {isAdmin && (
            ...
            {books.length > 0 ? (
                ...
                <Typography variant="h5" sx={{ color: "white", textAlign: "center" }}>No books found!</Typography>
            )}

            {
                user && !isAdmin && (
                    <>
                        <div className={`${classes.pageHeader} ${classes.mb2}`} style={{ color: "white", textAlign: "center" }}>
                            <Typography variant="h5" sx={{ color: "white", textAlign: "center" }}>Borrowed Books</Typography>
                        </div>
                        {borrowedBook.length > 0 ? (
                            ...
                            <Typography variant="h5" sx={{ color: "white", textAlign: "center" }}>No books issued!</Typography>
                        )}
                    </>
                )
            }
